...
function registrasi($data) {
  ...
  //jika kolom tidak diisi semua
  if (empty($username) || empty($password1) || empty($password2)) {
    echo "<script>
          alert('Silahkan isi semua kolom yang diberikan!!!');
          document.location.href = 'registrasi.php';
          </script>";
          return false;
  }

  //hjika username sudah ada
...
//jika username dan password telah sesuai
